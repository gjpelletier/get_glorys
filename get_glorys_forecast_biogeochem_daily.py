...
# ----------
# get_glorys_forecast_biogeochem_daily.py 
# 
# Python script to extract daily GLORYS model output
# from the Global Ocean Biogeochemistry Analysis and Forecast between 11/1/2020 to present + 6 days
#
...
#    from beginning to end. Each nc file name has the format glorys_biogeochem_yyyy_MM_dd.nc to indicate the date stamp
#
# - - -
...
for dt in dt_list:
    ...
    out_fn = datetime.strftime(dt, 'glorys_biogeochem_%Y_%m_%d') + '.nc'
